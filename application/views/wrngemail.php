	...
	<div  class="row bod stdiv">
	  <div class="col-md-2 col-md-offset-1"></div>
	    <div class="col-md-5 bord stdiv">
	     ...
	     <div class="row">
	     <div class="col-md-8 col-md-offset-1"><span class="h4">enter email:</span><input class="input-xs col-md-2" type="password" name=""></div>
	    <br> <hr style="color: white">
		 ...
		 <div class="row">
		 	...
		 	<div class="col-md-5"><input class="input-xs" type="password" name=""></div><br>
